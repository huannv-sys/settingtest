...
export const capsmanAPs = pgTable("capsman_aps", {
  ...
  clients: integer("clients").default(0),
  uptime: text("uptime"),
  txPower: text("tx_power"), // Công suất phát
  rxSignal: text("rx_signal"), // Độ nhiễu tín hiệu
  channel: text("channel"), // Kênh hoạt động
  band: text("band"), // Băng tần sử dụng (2ghz/5ghz)
  channelWidth: text("channel_width"), // Độ rộng kênh
